...
| 2026/8/13 | 	4.2.02 | 	4.2 draft | 	Nishioka
| 2026/9/21 | 	4.2.02 | 	4.2 draft | 	Nishioka
...
| 10084 | Energy Specification | Represents the specification conditions required of an energy source. | Energy Management | Specification |
| 10085 | Energy Node | Represents a connection point for the supply or consumption of energy. | Energy Management | Portion |
| 10086 | Energy Capacity | Represents a shareable energy supply capacity. | Energy Management | Capacity |
| 10087 | Energy Order | Represents an order for the supply or consumption of energy. | Energy Management | Order |
| 10088 | Energy Schedule | Represents a schedule for the supply or consumption of energy. | Energy Management | Schedule |
| 10089 | Energy Performance | Represents the actual supply or consumption performance of energy. | Energy Management | Performance |
| 10090 | Energy Result | Represents the recorded result for each energy node. | Energy Management | Result |
| 10091 | Customer | Represents the enterprise to which sales items are provided. | Sales Management | Company |
| 10092 | Sales Item | Represents a production item provided to a customer. | Sales Management | Product |
| 10093 | Sales Document | Represents the management unit for an order received from a customer. | Sales Management | Order Document |
| 10094 | Sales Order | Represents the content of an order received, per sales item. | Sales Management | Order Content |
| 10095 | Sales Specification | Represents the sales conditions and specifications for each customer. | Sales Management | Specification |
| 10096 | Sales Invoice | Represents billing information issued to a customer. | Sales Management | Invoice |
| 10097 | Sales Forecast | Represents demand forecast information from a customer. | Sales Management | Forecast |
| 10098 | Sales Quotation | Represents a quotation request from, and response to, a customer. | Sales Management | Quotation |
| 10099 | Shipping Result | Represents the shipment result of a sales item. | Sales Management | Result |
| 10100 | Supplier | Represents the enterprise from which materials or parts are procured. | Purchase Management | Company |
| 10101 | Purchase Item | Represents a production item provided by a supplier. | Purchase Management | Product |
| 10102 | Purchase Document | Represents the management unit for an order placed with a supplier. | Purchase Management | Order Document |
| 10103 | Purchase Order | Represents the individual order content placed with a supplier. | Purchase Management | Order Content |
| 10104 | Purchase Specification | Represents the purchasing conditions and specifications for each supplier. | Purchase Management | Specification |
| 10105 | Purchase Invoice | Represents billing information received from a supplier. | Purchase Management | Invoice |
| 10106 | Purchase Forecast | Represents a purchasing forecast notice to a supplier. | Purchase Management | Forecast |
| 10107 | Purchase Quotation | Represents a quotation request to, and response from, a supplier. | Purchase Management | Quotation |
| 10108 | Receiving Result | Represents the receiving result of a purchase item. | Purchase Management | Result |
...
direction LR
  ...
  Production Item Group <-- Sales Plan
  Production Item Group <-- Purchase Plan

  Production Item Group <-- Production Plan 
  Production Plan --> Site
  Production Plan --> Term

  Equipment Group <-- Capacity Plan  
  Personnel Group <-- Capacity Plan
...
direction LR
  ...
  Production Item Group <-- Production Capacity 
  Production Capacity --> Term

  Equipment Group <-- Equipment Capacity
  Equipment Capacity --> Term

  Personnel Group <-- Work Capacity
  Work Capacity --> Term
  Work Capacity --> Site

  Production Item <-- Inventory Capacity 
  Inventory Capacity --> Site
  Inventory Capacity --> Term 
  Production Item --> Production Item Group
  %%Calendar <-- Term
```
...
direction RL
  ...
  Asset --> Asset Group
  Asset Structure --> Asset Group:parent
  Asset Structure --> Asset Group:child
  Asset Structure --> Asset:parent
  Asset Structure --> Asset:child

  Asset <-- Asset Specification
  Personnel --> Asset
  Production Item --> Asset
  Asset <-- Equipment
...
direction RL
  ...
  Monitoring Result --> Monitoring Content
  Term <-- Monitoring Result
  Monitoring Content --> Asset
  Calendar <-- Term
```
...
direction RL
  ...
  Production Item --> Production Item Group
  Production Item Structure --> Production Item Group:parent
  Production Item Structure --> Production Item Group:child
  Production Item Structure --> Production Item:parent
  Production Item Structure --> Production Item:child
  Production Item <-- Production Item Specification 
  Production Item Function --> Production Item
  Production Item Portion --> Production Item
  Production Item <-- Production Item Result
  Production Item --> Production Process
...
classDiagram
direction RL
  class Production Item Document
  class Production Item Issue
  class Production Item Countermeasure
  
  Production Item Document --> Production Item
  Production Item --> Production Item Group
  Production Item Issue --> Production Item
  Production Item Issue --> Production Item Group
  Production Item Countermeasure --> Production Item Issue
```
...
direction RL
  ...
  Production Operation --> Production Process
  Production Content --> Production Operation
  
  Production Schedule --> Production Order
  Production Result --> Production Schedule
  
  Production Order --> Production Process
  Production Schedule --> Production Operation
  Production Result --> Production Content

  Equipment <-- Production Schedule 
  Personnel <-- Production Schedule 

  Term <-- Production Performance
  Production Performance --> Production Process
...
direction RL
  ...
  Production Schedule --> Production Order 
  Production Schedule <-- Production Result
  Production Schedule --> Inventory Order 

  Production Order --> Production Item
  Inventory Order --> Production Item
  Inventory Order --> Production Order
  Production Schedule --> Production Item
  Production Result --> Production Item
  
  Production Order --> Production Process
  Production Process --> Production Item Group
  Production Item --> Production Item Group
```
...
direction RL
  ...
  Production Process <-- Production Operation
  Production Operation --> Equipment Group
  Production Operation --> Personnel Group
  Equipment --> Equipment Group

  Production Assignment --> Production Operation
  Production Assignment --> Equipment
  Production Assignment --> Personnel
  Production Item <-- Production Assignment
```
...
direction RL
  ...
  class Production Issue
  class Production Countermeasure
  
  %% Equipment --> Equipment Group
  Production Document --> Production Process
  Production Issue --> Production Process
  %% Production Issue --> Equipment Group
  Production Countermeasure --> Production Issue
```
...
direction RL
  ...
  Equipment --> Equipment Group
  Equipment Structure --> Equipment Group:parent
  Equipment Structure --> Equipment Group:child
  Equipment Structure --> Equipment:parent
  Equipment Structure --> Equipment:child
  Equipment Function --> Equipment
  Equipment Portion --> Equipment
...
direction RL
  ...
  class Equipment Countermeasure

  Equipment Document --> Equipment
  Equipment Issue --> Equipment
  Equipment Issue --> Equipment Group
  Equipment --> Equipment Group
  Equipment Countermeasure --> Equipment Issue
```
...
direction RL
  ...
  Equipment Operation --> Equipment Process
  Equipment Order --> Equipment Process
  Equipment Performance --> Equipment Process

  Equipment Content --> Equipment Operation
  Equipment Schedule --> Equipment Order

  Equipment Schedule --> Equipment Operation

  Equipment Result --> Equipment Schedule
  Equipment Result --> Equipment Content

  Equipment <--   Equipment Schedule
  Personnel <-- Equipment Schedule  
...
classDiagram
direction RL
  Equipment Process <-- Equipment Operation

  Equipment Assignment --> Equipment Operation
  Equipment Assignment --> Equipment
  Equipment Assignment --> Personnel

  Equipment Operation --> Equipment Group
  Equipment --> Equipment Group
  Equipment Operation --> Personnel Group
...
direction RL
  ...
  Personnel --> Personnel Group
  Personnel Structure --> Personnel Group:parent
  Personnel Structure --> Personnel Group:child
  Personnel Structure --> Personnel:parent
  Personnel Structure --> Personnel:child
  Personnel <-- Personnel Specification
  Personnel Skill --> Personnel
  Personnel Portion --> Personnel
...
direction RL
  ...
  Personnel --> Personnel Group
  Personnel Issue --> Personnel Group
  Personnel Document --> Personnel
  Personnel Issue --> Personnel
  Personnel Countermeasure --> Personnel Issue 
```
...
direction RL
  ...
  Work Operation --> Work Process
  Work Order --> Work Process
  Work Performance --> Work Process

  Work Content --> Work Operation
  Work Result --> Work Content

  Work Schedule --> Work Order
  Work Result --> Work Schedule
  %% Added below
  Work Schedule --> Work Operation 
...
direction RL
  ...
  Work Process <-- Work Operation 

  Work Operation --> Personnel Group
  Work Operation --> Equipment Group

  Equipment --> Equipment Group
  Personnel --> Personnel Group

  Work Assignment --> Equipment
  Work Assignment --> Personnel
  Work Assignment --> Work Operation
...
direction RL
  ...
  class Inventory Schedule
  %%class Inventory Transfer
  %%class Inventory Result

  %% ================

  Inventory Item --> Production Item
  Inventory Item --> Production Line
  
  Inventory Schedule --> Inventory Order
  Inventory Item <-- Inventory Schedule:from
  Inventory Item <-- Inventory Schedule:to
  
  Production Item <-- Inventory Order
  Production Order <-- Inventory Order

  Inventory Item <-- Inventory Transfer 
  Inventory Transfer <-- Inventory Schedule

  Production Process <-- Inventory Transfer
  Inventory Transfer --> Equipment Group
  Inventory Transfer --> Personnel Group
...
direction RL
  ...
  Energy --> Energy Group
  Energy Structure --> Energy:parent
  Energy Structure --> Energy:child
  Energy Node --> Energy
  %%Energy Function --> Energy
  Energy <-- Energy Specification
  Equipment --> Energy Node
```
...
direction RL
  class Energy Order
  class Energy Schedule
  class Energy Performance
  class Energy Result

  Energy Order --> Energy Node
  Equipment --> Energy Node
  Energy Schedule --> Energy Order
  Energy Result --> Energy Schedule
  Energy Result --> Equipment
  Energy Performance --> Energy Node

  %%Energy Performance --> Energy Order



  %%Energy Group <-- Energy Plan 
  Energy Capacity --> Energy Group

  %%Energy Plan --> Term
  %%Energy Plan --> Site

  Energy Capacity --> Site
  Energy Capacity --> Term
...
direction LR
  ...
  Sales Document --> Customer
  Sales Quotation --> Customer
  Sales Item --> Customer

  Sales Document <-- Sales Order 
  Sales Order <-- Shipping Result

  Sales Order --> Sales Item
  Sales Quotation --> Sales Item
  Sales Item --> Production Item
  Sales Item <-- Sales Specification
...
direction LR
  ...
  Sales Item <-- Sales Forecast 
  Sales Item <-- Sales Quotation
  Sales Item <-- Sales Order
  Sales Item --> Customer

  Sales Order <-- Shipping Result
  Shipping Result <-- Sales Invoice
...
direction LR
  ...
  Purchase Document --> Supplier
  Purchase Quotation --> Supplier
  Purchase Item --> Supplier

  Purchase Document <-- Purchase Order 
  Purchase Order <-- Receiving Result

  Purchase Order --> Purchase Item
  Purchase Quotation --> Purchase Item
  Purchase Item --> Production Item
  Purchase Item <-- Purchase Specification
...
classDiagram
direction LR
  Purchase Item <-- Purchase Forecast 
  Purchase Item <-- Purchase Quotation
  Purchase Item <-- Purchase Order
  Purchase Item --> Supplier

  Purchase Order <-- Receiving Result
  Receiving Result <-- Purchase Invoice
...
| Attribute Name | Data Type | Description |
|---|---|---|
| index_no | number | An attribute representing an order such as display order, process order, or operation order. |
| note | string | An attribute recording a remark, the content of an issue, or the content of a countermeasure. |
| value | number | An attribute representing a value such as a quantity, capacity, or performance figure. |
| unit | string | An attribute representing the unit of the value. |
...
| value | number | An attribute representing a value such as a quantity, capacity, or performance figure. |
| unit | string | An attribute representing the unit of the value. |
| work_time | number | An attribute representing the standard time required for the work. |
...
| Attribute Name | Data Type | Description |
|---|---|---|
| index_no | number | An attribute representing display order, priority order, or the like. |
| specification | string | A descriptive attribute recording a specification, condition, or content. |
| value | number | An attribute representing a value such as a quantity, capacity, or performance figure. |
| unit | string | An attribute representing the unit of the value. |
...
| description | varchar | Record a description, specification, or characteristic of the target. |
| production_item_id | FK | Cross-references the Production Item table via a foreign key. |
| production_process_id | FK | Cross-references the Production Line table via a foreign key. |
| specification | string | A descriptive attribute recording a specification, condition, or content. |
| value | number | An attribute representing a value such as a quantity, capacity, or performance figure. |
| unit | string | An attribute representing the unit of the value. |
| location | string | An attribute representing a location, position, storage location, or place of execution. |
...
| description | varchar | Record a description, specification, or characteristic of the target. |
| inventory_order_id | FK | Cross-references the Inventory Order table via a foreign key. |
| inventory_transfer_id | FK | Cross-references the Inventory Transfer table via a foreign key. |
