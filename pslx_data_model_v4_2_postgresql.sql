--------------------------------------------------------------------------
-- PSLXスキーマ 4.2  PostgreSQL 用 DDL
-- 変換元: 汎用SQL(DBML由来)
-- 変換ルール:
--   varchar                 -> VARCHAR(n)  (id/*_id列は36, description等の長文列は1000, その他は100)
--   decimal                 -> NUMERIC(18,4)  (PostgreSQLの慣例に合わせNUMERICを使用)
--   datetime                -> TIMESTAMP  (PostgreSQLにDATETIME型は存在しないため)
--   外部キー制約に CONSTRAINT 名を明示付与(fk_テーブル名_カラム名、63バイト制限内)
--   COMMENT ON TABLE/COLUMN はPostgreSQL標準構文のためそのまま使用可能
--   DEFERRABLE INITIALLY IMMEDIATE はPostgreSQLのネイティブ構文としてそのまま有効
--------------------------------------------------------------------------
...
CREATE TABLE "production_plan" (
  ...
  "site_id" VARCHAR(36),
  "term_id" VARCHAR(36),
  "production_item_group_id" VARCHAR(36),
  "specification" VARCHAR(1000),
...
CREATE TABLE "capacity_plan" (
  ...
  "site_id" VARCHAR(36),
  "term_id" VARCHAR(36),
  "equipment_group_id" VARCHAR(36),
  "personnel_group_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "planned_value" NUMERIC(18,4),
  "actual_value" NUMERIC(18,4),
  "unit" VARCHAR(100),
...
CREATE TABLE "asset_structure" (
  ...
  "status" VARCHAR(100),
  "description" VARCHAR(1000),
  "parent_asset_group_id" VARCHAR(36),
  "child_asset_group_id" VARCHAR(36),
  "parent_asset_id" VARCHAR(36),
  "child_asset_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
  "created_at" TIMESTAMP,
...
CREATE TABLE "monitoring_result" (
  ...
  "status" VARCHAR(100),
  "description" VARCHAR(1000),
  "monitoring_content_id" VARCHAR(36),
  "term_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
...
CREATE TABLE "production_item" (
  ...
  "asset_id" VARCHAR(36),
  "production_item_group_id" VARCHAR(36),
  "production_process_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "location" VARCHAR(100),
  "created_at" TIMESTAMP,
  "updated_at" TIMESTAMP,
...
CREATE TABLE "production_item_structure" (
  ...
  "status" VARCHAR(100),
  "description" VARCHAR(1000),
  "parent_production_item_group_id" VARCHAR(36),
  "child_production_item_group_id" VARCHAR(36),
  "parent_production_item_id" VARCHAR(36),
  "child_production_item_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
  "created_at" TIMESTAMP,
...
CREATE TABLE "production_item_countermeasure" (
  ...
  "status" VARCHAR(100),
  "description" VARCHAR(1000),
  "production_item_issue_id" VARCHAR(36),
  "index_no" NUMERIC(18,4),
  "note" VARCHAR(1000),
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
...
CREATE TABLE "production_item_result" (
  ...
  "description" VARCHAR(1000),
  "production_item_id" VARCHAR(36),
  "production_schedule_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
  "location" VARCHAR(100),
...
CREATE TABLE "production_operation" (
  ...
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
  "work_hours" NUMERIC(18,4),
  "work_days" NUMERIC(18,4),
  "created_at" TIMESTAMP,
  "updated_at" TIMESTAMP,
  "created_by" VARCHAR(100),
  "approved_by" VARCHAR(100),
...
CREATE TABLE "production_content" (
  ...
  "status" VARCHAR(100),
  "description" VARCHAR(1000),
  "production_operation_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
  "created_at" TIMESTAMP,
...
CREATE TABLE "production_result" (
  ...
  "description" VARCHAR(1000),
  "production_schedule_id" VARCHAR(36),
  "production_content_id" VARCHAR(36),
  "personnel_id" VARCHAR(36),
  "production_item_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "value" NUMERIC(18,4),
...
CREATE TABLE "production_countermeasure" (
  ...
  "status" VARCHAR(100),
  "description" VARCHAR(1000),
  "production_issue_id" VARCHAR(36),
  "index_no" NUMERIC(18,4),
  "note" VARCHAR(1000),
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
...
CREATE TABLE "equipment_structure" (
  ...
  "status" VARCHAR(100),
  "description" VARCHAR(1000),
  "parent_equipment_group_id" VARCHAR(36),
  "child_equipment_group_id" VARCHAR(36),
  "parent_equipment_id" VARCHAR(36),
  "child_equipment_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
  "created_at" TIMESTAMP,
...
CREATE TABLE "equipment_operation" (
  ...
  "status" VARCHAR(100),
  "description" VARCHAR(1000),
  "equipment_process_id" VARCHAR(36),
  "equipment_group_id" VARCHAR(36),
  "personnel_group_id" VARCHAR(36),
  "index_no" NUMERIC(18,4),
  "specification" VARCHAR(1000),
...
CREATE TABLE "equipment_content" (
  ...
  "status" VARCHAR(100),
  "description" VARCHAR(1000),
  "equipment_operation_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
  "created_at" TIMESTAMP,
...
CREATE TABLE "equipment_result" (
  ...
  "status" VARCHAR(100),
  "description" VARCHAR(1000),
  "equipment_content_id" VARCHAR(36),
  "equipment_schedule_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
  "location" VARCHAR(100),
...
CREATE TABLE "work_result" (
  ...
  "status" VARCHAR(100),
  "description" VARCHAR(1000),
  "work_schedule_id" VARCHAR(36),
  "work_content_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
  "location" VARCHAR(100),
...
CREATE TABLE "inventory_schedule" (
  ...
  "status" VARCHAR(100),
  "description" VARCHAR(1000),
  "inventory_transfer_id" VARCHAR(36),
  "inventory_order_id" VARCHAR(36),
  "from_inventory_item_id" VARCHAR(36),
  "to_inventory_item_id" VARCHAR(36),
  "index_no" NUMERIC(18,4),
  "specification" VARCHAR(1000),
  "planned_value" NUMERIC(18,4),
  "actual_value" NUMERIC(18,4),
...
CREATE TABLE "inventory_result" (
  ...
  "description" VARCHAR(1000),
  "inventory_item_id" VARCHAR(36),
  "inventory_schedule_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
  "location" VARCHAR(100),
...
CREATE TABLE "purchase_order" (
  ...
  "status" VARCHAR(100),
  "description" VARCHAR(1000),
  "purchase_document_id" VARCHAR(36),
...
CREATE TABLE "purchase_invoice" (
  ...
  "description" VARCHAR(1000),
  "supplier_id" VARCHAR(36),
  "receiving_result_id" VARCHAR(36),
  "specification" VARCHAR(1000),
  "value" NUMERIC(18,4),
  "unit" VARCHAR(100),
  "unit_price" NUMERIC(18,4),
...
COMMENT ON COLUMN "capacity_plan"."personnel_group_id" IS '作業者グループID';
...
COMMENT ON COLUMN "sales_plan"."production_item_group_id" IS '品目グループID';
...
COMMENT ON COLUMN "purchase_plan"."production_item_group_id" IS '品目グループID';
...
COMMENT ON COLUMN "production_order"."production_item_id" IS '生産品目ID';
...
COMMENT ON COLUMN "production_schedule"."production_item_id" IS '生産品目ID';
...
COMMENT ON COLUMN "production_result"."production_item_id" IS '生産品目ID';
...
COMMENT ON COLUMN "production_document"."production_process_id" IS '生産工程ID';
...
COMMENT ON COLUMN "production_issue"."production_process_id" IS '生産プロセスID';
...
COMMENT ON COLUMN "equipment_process"."equipment_group_id" IS '設備グループID';
...
COMMENT ON COLUMN "work_process"."personnel_group_id" IS '作業者グループID';
...
COMMENT ON COLUMN "work_capacity"."personnel_group_id" IS '作業者グループID';
...
COMMENT ON COLUMN "work_schedule"."work_operation_id" IS '作業手順ID';

COMMENT ON COLUMN "work_schedule"."equipment_id" IS '設備ID';

COMMENT ON COLUMN "work_schedule"."personnel_id" IS '作業者ID';
...
COMMENT ON COLUMN "work_performance"."work_process_id" IS '作業オーダID';
...
COMMENT ON COLUMN "inventory_item"."production_line_id" IS '生産ラインID';
...
COMMENT ON COLUMN "inventory_schedule"."inventory_transfer_id" IS '在庫移動ID';
...
COMMENT ON COLUMN "inventory_transfer"."equipment_group_id" IS '設備グループID';

COMMENT ON COLUMN "inventory_transfer"."personnel_group_id" IS '作業者グループID';
...
COMMENT ON COLUMN "sales_item"."customer_id" IS '得意先ID';
...
COMMENT ON COLUMN "sales_document"."customer_id" IS '得意先ID';
...
COMMENT ON COLUMN "sales_specification"."sales_item_id" IS '販売品目ID';
...
COMMENT ON COLUMN "sales_invoice"."customer_id" IS '得意先ID';
...
COMMENT ON COLUMN "sales_quotation"."customer_id" IS '得意先ID';
...
COMMENT ON COLUMN "purchase_specification"."purchase_item_id" IS '購買品目ID';
...
ALTER TABLE "area" ADD CONSTRAINT "fk_area_site_id" FOREIGN KEY ("site_id") REFERENCES "site" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "site" ADD CONSTRAINT "fk_site_enterprise_id" FOREIGN KEY ("enterprise_id") REFERENCES "enterprise" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_line" ADD CONSTRAINT "fk_production_line_area_id" FOREIGN KEY ("area_id") REFERENCES "area" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "calendar" ADD CONSTRAINT "fk_calendar_site_id" FOREIGN KEY ("site_id") REFERENCES "site" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "term" ADD CONSTRAINT "fk_term_calendar_id" FOREIGN KEY ("calendar_id") REFERENCES "calendar" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_plan" ADD CONSTRAINT "fk_production_plan_site_id" FOREIGN KEY ("site_id") REFERENCES "site" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_plan" ADD CONSTRAINT "fk_production_plan_term_id" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_plan" ADD CONSTRAINT "fk_production_plan_production_item_group_id" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "capacity_plan" ADD CONSTRAINT "fk_capacity_plan_site_id" FOREIGN KEY ("site_id") REFERENCES "site" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "capacity_plan" ADD CONSTRAINT "fk_capacity_plan_term_id" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "capacity_plan" ADD CONSTRAINT "fk_capacity_plan_equipment_group_id" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "capacity_plan" ADD CONSTRAINT "fk_capacity_plan_personnel_group_id" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_plan" ADD CONSTRAINT "fk_sales_plan_site_id" FOREIGN KEY ("site_id") REFERENCES "site" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_plan" ADD CONSTRAINT "fk_sales_plan_term_id" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_plan" ADD CONSTRAINT "fk_sales_plan_production_item_group_id" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_plan" ADD CONSTRAINT "fk_purchase_plan_site_id" FOREIGN KEY ("site_id") REFERENCES "site" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_plan" ADD CONSTRAINT "fk_purchase_plan_term_id" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_plan" ADD CONSTRAINT "fk_purchase_plan_production_item_group_id" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "asset" ADD CONSTRAINT "fk_asset_asset_group_id" FOREIGN KEY ("asset_group_id") REFERENCES "asset_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "asset_structure" ADD CONSTRAINT "fk_asset_structure_parent_asset_group_id" FOREIGN KEY ("parent_asset_group_id") REFERENCES "asset_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "asset_structure" ADD CONSTRAINT "fk_asset_structure_child_asset_group_id" FOREIGN KEY ("child_asset_group_id") REFERENCES "asset_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "asset_structure" ADD CONSTRAINT "fk_asset_structure_parent_asset_id" FOREIGN KEY ("parent_asset_id") REFERENCES "asset" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "asset_structure" ADD CONSTRAINT "fk_asset_structure_child_asset_id" FOREIGN KEY ("child_asset_id") REFERENCES "asset" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "asset_specification" ADD CONSTRAINT "fk_asset_specification_asset_id" FOREIGN KEY ("asset_id") REFERENCES "asset" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "monitoring_content" ADD CONSTRAINT "fk_monitoring_content_asset_id" FOREIGN KEY ("asset_id") REFERENCES "asset" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "monitoring_result" ADD CONSTRAINT "fk_monitoring_result_monitoring_content_id" FOREIGN KEY ("monitoring_content_id") REFERENCES "monitoring_content" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "monitoring_result" ADD CONSTRAINT "fk_monitoring_result_term_id" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item" ADD CONSTRAINT "fk_production_item_asset_id" FOREIGN KEY ("asset_id") REFERENCES "asset" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item" ADD CONSTRAINT "fk_production_item_production_item_group_id" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item" ADD CONSTRAINT "fk_production_item_production_process_id" FOREIGN KEY ("production_process_id") REFERENCES "production_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_structure" ADD CONSTRAINT "fk_production_item_structure_parent_production_item_group_id" FOREIGN KEY ("parent_production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_structure" ADD CONSTRAINT "fk_production_item_structure_child_production_item_group_id" FOREIGN KEY ("child_production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_structure" ADD CONSTRAINT "fk_production_item_structure_parent_production_item_id" FOREIGN KEY ("parent_production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_structure" ADD CONSTRAINT "fk_production_item_structure_child_production_item_id" FOREIGN KEY ("child_production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_function" ADD CONSTRAINT "fk_production_item_function_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_specification" ADD CONSTRAINT "fk_production_item_specification_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_portion" ADD CONSTRAINT "fk_production_item_portion_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_document" ADD CONSTRAINT "fk_production_item_document_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_issue" ADD CONSTRAINT "fk_production_item_issue_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_issue" ADD CONSTRAINT "fk_production_item_issue_production_item_group_id" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_countermeasure" ADD CONSTRAINT "fk_production_item_countermeasure_production_item_issue_id" FOREIGN KEY ("production_item_issue_id") REFERENCES "production_item_issue" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_result" ADD CONSTRAINT "fk_production_item_result_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_result" ADD CONSTRAINT "fk_production_item_result_production_schedule_id" FOREIGN KEY ("production_schedule_id") REFERENCES "production_schedule" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_process" ADD CONSTRAINT "fk_production_process_production_item_group_id" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_operation" ADD CONSTRAINT "fk_production_operation_production_process_id" FOREIGN KEY ("production_process_id") REFERENCES "production_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_operation" ADD CONSTRAINT "fk_production_operation_equipment_group_id" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_operation" ADD CONSTRAINT "fk_production_operation_personnel_group_id" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_content" ADD CONSTRAINT "fk_production_content_production_operation_id" FOREIGN KEY ("production_operation_id") REFERENCES "production_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_assignment" ADD CONSTRAINT "fk_production_assignment_production_operation_id" FOREIGN KEY ("production_operation_id") REFERENCES "production_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_assignment" ADD CONSTRAINT "fk_production_assignment_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_assignment" ADD CONSTRAINT "fk_production_assignment_personnel_id" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_capacity" ADD CONSTRAINT "fk_production_capacity_term_id" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_capacity" ADD CONSTRAINT "fk_production_capacity_production_item_group_id" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_order" ADD CONSTRAINT "fk_production_order_production_process_id" FOREIGN KEY ("production_process_id") REFERENCES "production_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_order" ADD CONSTRAINT "fk_production_order_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_schedule" ADD CONSTRAINT "fk_production_schedule_production_order_id" FOREIGN KEY ("production_order_id") REFERENCES "production_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_schedule" ADD CONSTRAINT "fk_production_schedule_production_operation_id" FOREIGN KEY ("production_operation_id") REFERENCES "production_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_schedule" ADD CONSTRAINT "fk_production_schedule_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_schedule" ADD CONSTRAINT "fk_production_schedule_personnel_id" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_schedule" ADD CONSTRAINT "fk_production_schedule_production_line_id" FOREIGN KEY ("production_line_id") REFERENCES "production_line" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_schedule" ADD CONSTRAINT "fk_production_schedule_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_performance" ADD CONSTRAINT "fk_production_performance_term_id" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_performance" ADD CONSTRAINT "fk_production_performance_production_process_id" FOREIGN KEY ("production_process_id") REFERENCES "production_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_result" ADD CONSTRAINT "fk_production_result_production_schedule_id" FOREIGN KEY ("production_schedule_id") REFERENCES "production_schedule" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_result" ADD CONSTRAINT "fk_production_result_production_content_id" FOREIGN KEY ("production_content_id") REFERENCES "production_content" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_result" ADD CONSTRAINT "fk_production_result_personnel_id" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_result" ADD CONSTRAINT "fk_production_result_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_document" ADD CONSTRAINT "fk_production_document_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_document" ADD CONSTRAINT "fk_production_document_production_process_id" FOREIGN KEY ("production_process_id") REFERENCES "production_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_issue" ADD CONSTRAINT "fk_production_issue_production_process_id" FOREIGN KEY ("production_process_id") REFERENCES "production_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_issue" ADD CONSTRAINT "fk_production_issue_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_issue" ADD CONSTRAINT "fk_production_issue_equipment_group_id" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_countermeasure" ADD CONSTRAINT "fk_production_countermeasure_production_issue_id" FOREIGN KEY ("production_issue_id") REFERENCES "production_issue" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment" ADD CONSTRAINT "fk_equipment_production_line_id" FOREIGN KEY ("production_line_id") REFERENCES "production_line" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment" ADD CONSTRAINT "fk_equipment_asset_id" FOREIGN KEY ("asset_id") REFERENCES "asset" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment" ADD CONSTRAINT "fk_equipment_equipment_group_id" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment" ADD CONSTRAINT "fk_equipment_energy_node_id" FOREIGN KEY ("energy_node_id") REFERENCES "energy_node" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_group" ADD CONSTRAINT "fk_equipment_group_asset_group_id" FOREIGN KEY ("asset_group_id") REFERENCES "asset_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_structure" ADD CONSTRAINT "fk_equipment_structure_parent_equipment_group_id" FOREIGN KEY ("parent_equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_structure" ADD CONSTRAINT "fk_equipment_structure_child_equipment_group_id" FOREIGN KEY ("child_equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_structure" ADD CONSTRAINT "fk_equipment_structure_parent_equipment_id" FOREIGN KEY ("parent_equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_structure" ADD CONSTRAINT "fk_equipment_structure_child_equipment_id" FOREIGN KEY ("child_equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_function" ADD CONSTRAINT "fk_equipment_function_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_specification" ADD CONSTRAINT "fk_equipment_specification_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_portion" ADD CONSTRAINT "fk_equipment_portion_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_document" ADD CONSTRAINT "fk_equipment_document_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_issue" ADD CONSTRAINT "fk_equipment_issue_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_issue" ADD CONSTRAINT "fk_equipment_issue_equipment_group_id" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_countermeasure" ADD CONSTRAINT "fk_equipment_countermeasure_equipment_issue_id" FOREIGN KEY ("equipment_issue_id") REFERENCES "equipment_issue" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_process" ADD CONSTRAINT "fk_equipment_process_equipment_group_id" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_operation" ADD CONSTRAINT "fk_equipment_operation_equipment_process_id" FOREIGN KEY ("equipment_process_id") REFERENCES "equipment_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_operation" ADD CONSTRAINT "fk_equipment_operation_equipment_group_id" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_operation" ADD CONSTRAINT "fk_equipment_operation_personnel_group_id" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_content" ADD CONSTRAINT "fk_equipment_content_equipment_operation_id" FOREIGN KEY ("equipment_operation_id") REFERENCES "equipment_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_assignment" ADD CONSTRAINT "fk_equipment_assignment_equipment_operation_id" FOREIGN KEY ("equipment_operation_id") REFERENCES "equipment_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_assignment" ADD CONSTRAINT "fk_equipment_assignment_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_assignment" ADD CONSTRAINT "fk_equipment_assignment_personnel_id" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_capacity" ADD CONSTRAINT "fk_equipment_capacity_term_id" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_capacity" ADD CONSTRAINT "fk_equipment_capacity_equipment_group_id" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_order" ADD CONSTRAINT "fk_equipment_order_equipment_process_id" FOREIGN KEY ("equipment_process_id") REFERENCES "equipment_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_schedule" ADD CONSTRAINT "fk_equipment_schedule_equipment_operation_id" FOREIGN KEY ("equipment_operation_id") REFERENCES "equipment_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_schedule" ADD CONSTRAINT "fk_equipment_schedule_equipment_order_id" FOREIGN KEY ("equipment_order_id") REFERENCES "equipment_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_schedule" ADD CONSTRAINT "fk_equipment_schedule_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_schedule" ADD CONSTRAINT "fk_equipment_schedule_personnel_id" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_performance" ADD CONSTRAINT "fk_equipment_performance_term_id" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_performance" ADD CONSTRAINT "fk_equipment_performance_equipment_process_id" FOREIGN KEY ("equipment_process_id") REFERENCES "equipment_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_result" ADD CONSTRAINT "fk_equipment_result_equipment_content_id" FOREIGN KEY ("equipment_content_id") REFERENCES "equipment_content" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_result" ADD CONSTRAINT "fk_equipment_result_equipment_schedule_id" FOREIGN KEY ("equipment_schedule_id") REFERENCES "equipment_schedule" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel" ADD CONSTRAINT "fk_personnel_production_line_id" FOREIGN KEY ("production_line_id") REFERENCES "production_line" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel" ADD CONSTRAINT "fk_personnel_asset_id" FOREIGN KEY ("asset_id") REFERENCES "asset" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel" ADD CONSTRAINT "fk_personnel_personnel_group_id" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_group" ADD CONSTRAINT "fk_personnel_group_asset_group_id" FOREIGN KEY ("asset_group_id") REFERENCES "asset_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_structure" ADD CONSTRAINT "fk_personnel_structure_personnel_group_id" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_structure" ADD CONSTRAINT "fk_personnel_structure_personnel_id" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_skill" ADD CONSTRAINT "fk_personnel_skill_personnel_id" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_specification" ADD CONSTRAINT "fk_personnel_specification_personnel_id" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_portion" ADD CONSTRAINT "fk_personnel_portion_personnel_id" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_document" ADD CONSTRAINT "fk_personnel_document_personnel_id" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_issue" ADD CONSTRAINT "fk_personnel_issue_personnel_id" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_issue" ADD CONSTRAINT "fk_personnel_issue_personnel_group_id" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_countermeasure" ADD CONSTRAINT "fk_personnel_countermeasure_personnel_issue_id" FOREIGN KEY ("personnel_issue_id") REFERENCES "personnel_issue" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_process" ADD CONSTRAINT "fk_work_process_personnel_group_id" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_operation" ADD CONSTRAINT "fk_work_operation_work_process_id" FOREIGN KEY ("work_process_id") REFERENCES "work_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_operation" ADD CONSTRAINT "fk_work_operation_equipment_group_id" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_operation" ADD CONSTRAINT "fk_work_operation_personnel_group_id" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_content" ADD CONSTRAINT "fk_work_content_work_operation_id" FOREIGN KEY ("work_operation_id") REFERENCES "work_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_assignment" ADD CONSTRAINT "fk_work_assignment_work_operation_id" FOREIGN KEY ("work_operation_id") REFERENCES "work_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_assignment" ADD CONSTRAINT "fk_work_assignment_personnel_id" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_assignment" ADD CONSTRAINT "fk_work_assignment_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_capacity" ADD CONSTRAINT "fk_work_capacity_site_id" FOREIGN KEY ("site_id") REFERENCES "site" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_capacity" ADD CONSTRAINT "fk_work_capacity_term_id" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_capacity" ADD CONSTRAINT "fk_work_capacity_personnel_group_id" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_order" ADD CONSTRAINT "fk_work_order_work_process_id" FOREIGN KEY ("work_process_id") REFERENCES "work_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_schedule" ADD CONSTRAINT "fk_work_schedule_work_order_id" FOREIGN KEY ("work_order_id") REFERENCES "work_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_schedule" ADD CONSTRAINT "fk_work_schedule_work_operation_id" FOREIGN KEY ("work_operation_id") REFERENCES "work_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_schedule" ADD CONSTRAINT "fk_work_schedule_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_schedule" ADD CONSTRAINT "fk_work_schedule_personnel_id" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_performance" ADD CONSTRAINT "fk_work_performance_work_process_id" FOREIGN KEY ("work_process_id") REFERENCES "work_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_performance" ADD CONSTRAINT "fk_work_performance_term_id" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_result" ADD CONSTRAINT "fk_work_result_work_schedule_id" FOREIGN KEY ("work_schedule_id") REFERENCES "work_schedule" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_result" ADD CONSTRAINT "fk_work_result_work_content_id" FOREIGN KEY ("work_content_id") REFERENCES "work_content" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_item" ADD CONSTRAINT "fk_inventory_item_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_item" ADD CONSTRAINT "fk_inventory_item_production_line_id" FOREIGN KEY ("production_line_id") REFERENCES "production_line" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_capacity" ADD CONSTRAINT "fk_inventory_capacity_site_id" FOREIGN KEY ("site_id") REFERENCES "site" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_capacity" ADD CONSTRAINT "fk_inventory_capacity_term_id" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_capacity" ADD CONSTRAINT "fk_inventory_capacity_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_order" ADD CONSTRAINT "fk_inventory_order_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_order" ADD CONSTRAINT "fk_inventory_order_production_order_id" FOREIGN KEY ("production_order_id") REFERENCES "production_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_schedule" ADD CONSTRAINT "fk_inventory_schedule_inventory_transfer_id" FOREIGN KEY ("inventory_transfer_id") REFERENCES "inventory_transfer" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_schedule" ADD CONSTRAINT "fk_inventory_schedule_inventory_order_id" FOREIGN KEY ("inventory_order_id") REFERENCES "inventory_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_schedule" ADD CONSTRAINT "fk_inventory_schedule_from_inventory_item_id" FOREIGN KEY ("from_inventory_item_id") REFERENCES "inventory_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_schedule" ADD CONSTRAINT "fk_inventory_schedule_to_inventory_item_id" FOREIGN KEY ("to_inventory_item_id") REFERENCES "inventory_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_transfer" ADD CONSTRAINT "fk_inventory_transfer_inventory_item_id" FOREIGN KEY ("inventory_item_id") REFERENCES "inventory_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_transfer" ADD CONSTRAINT "fk_inventory_transfer_equipment_group_id" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_transfer" ADD CONSTRAINT "fk_inventory_transfer_personnel_group_id" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_result" ADD CONSTRAINT "fk_inventory_result_inventory_item_id" FOREIGN KEY ("inventory_item_id") REFERENCES "inventory_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_result" ADD CONSTRAINT "fk_inventory_result_inventory_schedule_id" FOREIGN KEY ("inventory_schedule_id") REFERENCES "inventory_schedule" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy" ADD CONSTRAINT "fk_energy_energy_group_id" FOREIGN KEY ("energy_group_id") REFERENCES "energy_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_structure" ADD CONSTRAINT "fk_energy_structure_energy_id" FOREIGN KEY ("energy_id") REFERENCES "energy" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_function" ADD CONSTRAINT "fk_energy_function_energy_id" FOREIGN KEY ("energy_id") REFERENCES "energy" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_specification" ADD CONSTRAINT "fk_energy_specification_energy_id" FOREIGN KEY ("energy_id") REFERENCES "energy" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_node" ADD CONSTRAINT "fk_energy_node_energy_id" FOREIGN KEY ("energy_id") REFERENCES "energy" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_capacity" ADD CONSTRAINT "fk_energy_capacity_site_id" FOREIGN KEY ("site_id") REFERENCES "site" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_capacity" ADD CONSTRAINT "fk_energy_capacity_term_id" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_capacity" ADD CONSTRAINT "fk_energy_capacity_energy_group_id" FOREIGN KEY ("energy_group_id") REFERENCES "energy_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_order" ADD CONSTRAINT "fk_energy_order_energy_node_id" FOREIGN KEY ("energy_node_id") REFERENCES "energy_node" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_schedule" ADD CONSTRAINT "fk_energy_schedule_energy_order_id" FOREIGN KEY ("energy_order_id") REFERENCES "energy_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_performance" ADD CONSTRAINT "fk_energy_performance_energy_node_id" FOREIGN KEY ("energy_node_id") REFERENCES "energy_node" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_result" ADD CONSTRAINT "fk_energy_result_energy_schedule_id" FOREIGN KEY ("energy_schedule_id") REFERENCES "energy_schedule" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_result" ADD CONSTRAINT "fk_energy_result_equipment_id" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_item" ADD CONSTRAINT "fk_sales_item_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_item" ADD CONSTRAINT "fk_sales_item_customer_id" FOREIGN KEY ("customer_id") REFERENCES "customer" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_document" ADD CONSTRAINT "fk_sales_document_customer_id" FOREIGN KEY ("customer_id") REFERENCES "customer" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_order" ADD CONSTRAINT "fk_sales_order_sales_document_id" FOREIGN KEY ("sales_document_id") REFERENCES "sales_document" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_order" ADD CONSTRAINT "fk_sales_order_sales_item_id" FOREIGN KEY ("sales_item_id") REFERENCES "sales_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_specification" ADD CONSTRAINT "fk_sales_specification_sales_item_id" FOREIGN KEY ("sales_item_id") REFERENCES "sales_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_invoice" ADD CONSTRAINT "fk_sales_invoice_customer_id" FOREIGN KEY ("customer_id") REFERENCES "customer" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_invoice" ADD CONSTRAINT "fk_sales_invoice_shipping_result_id" FOREIGN KEY ("shipping_result_id") REFERENCES "shipping_result" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_forecast" ADD CONSTRAINT "fk_sales_forecast_sales_item_id" FOREIGN KEY ("sales_item_id") REFERENCES "sales_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_quotation" ADD CONSTRAINT "fk_sales_quotation_customer_id" FOREIGN KEY ("customer_id") REFERENCES "customer" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_quotation" ADD CONSTRAINT "fk_sales_quotation_sales_item_id" FOREIGN KEY ("sales_item_id") REFERENCES "sales_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "shipping_result" ADD CONSTRAINT "fk_shipping_result_sales_order_id" FOREIGN KEY ("sales_order_id") REFERENCES "sales_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_item" ADD CONSTRAINT "fk_purchase_item_production_item_id" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_item" ADD CONSTRAINT "fk_purchase_item_supplier_id" FOREIGN KEY ("supplier_id") REFERENCES "supplier" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_document" ADD CONSTRAINT "fk_purchase_document_supplier_id" FOREIGN KEY ("supplier_id") REFERENCES "supplier" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_order" ADD CONSTRAINT "fk_purchase_order_purchase_document_id" FOREIGN KEY ("purchase_document_id") REFERENCES "purchase_document" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_order" ADD CONSTRAINT "fk_purchase_order_purchase_item_id" FOREIGN KEY ("purchase_item_id") REFERENCES "purchase_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_specification" ADD CONSTRAINT "fk_purchase_specification_purchase_item_id" FOREIGN KEY ("purchase_item_id") REFERENCES "purchase_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_invoice" ADD CONSTRAINT "fk_purchase_invoice_supplier_id" FOREIGN KEY ("supplier_id") REFERENCES "supplier" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_invoice" ADD CONSTRAINT "fk_purchase_invoice_receiving_result_id" FOREIGN KEY ("receiving_result_id") REFERENCES "receiving_result" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_forecast" ADD CONSTRAINT "fk_purchase_forecast_purchase_item_id" FOREIGN KEY ("purchase_item_id") REFERENCES "purchase_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_quotation" ADD CONSTRAINT "fk_purchase_quotation_supplier_id" FOREIGN KEY ("supplier_id") REFERENCES "supplier" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_quotation" ADD CONSTRAINT "fk_purchase_quotation_purchase_item_id" FOREIGN KEY ("purchase_item_id") REFERENCES "purchase_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "receiving_result" ADD CONSTRAINT "fk_receiving_result_purchase_order_id" FOREIGN KEY ("purchase_order_id") REFERENCES "purchase_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;
