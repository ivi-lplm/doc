--------------------------------------------------------------------------
-- PSLXスキーマ 4.2  Oracle Database 用 DDL
-- 変換元: 汎用SQL(DBML由来)  ->  Oracle SQL
-- 変換ルール:
--   varchar                 -> VARCHAR2(n)  (id/*_id列は36, description等の長文列は1000, その他は100)
--   decimal                 -> NUMBER
--   datetime                -> TIMESTAMP
--   外部キー制約に CONSTRAINT 名を明示付与(fk_テーブル名_カラム名、30バイト制限内)
--   COMMENT ON TABLE/COLUMN はOracle標準構文のためそのまま使用可能
--   識別子は最大31バイトのものが含まれるため、Oracle 12.2以降(拡張識別子対応)を前提とする
--------------------------------------------------------------------------
...
CREATE TABLE "production_plan" (
  ...
  "site_id" VARCHAR2(36),
  "term_id" VARCHAR2(36),
  "production_item_group_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
...
CREATE TABLE "capacity_plan" (
  ...
  "site_id" VARCHAR2(36),
  "term_id" VARCHAR2(36),
  "equipment_group_id" VARCHAR2(36),
  "personnel_group_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "planned_value" NUMBER,
  "actual_value" NUMBER,
  "unit" VARCHAR2(100),
...
CREATE TABLE "asset_structure" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "parent_asset_group_id" VARCHAR2(36),
  "child_asset_group_id" VARCHAR2(36),
  "parent_asset_id" VARCHAR2(36),
  "child_asset_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "created_at" TIMESTAMP,
...
CREATE TABLE "monitoring_result" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "monitoring_content_id" VARCHAR2(36),
  "term_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
...
CREATE TABLE "production_item" (
  ...
  "asset_id" VARCHAR2(36),
  "production_item_group_id" VARCHAR2(36),
  "production_process_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "location" VARCHAR2(100),
  "created_at" TIMESTAMP,
  "updated_at" TIMESTAMP,
...
CREATE TABLE "production_item_structure" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "parent_production_item_group_id" VARCHAR2(36),
  "child_production_item_group_id" VARCHAR2(36),
  "parent_production_item_id" VARCHAR2(36),
  "child_production_item_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "created_at" TIMESTAMP,
...
CREATE TABLE "production_item_function" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "production_item_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "created_at" TIMESTAMP,
...
CREATE TABLE "production_item_countermeasure" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "production_item_issue_id" VARCHAR2(36),
  "index_no" NUMBER,
  "note" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
...
CREATE TABLE "production_item_result" (
  ...
  "description" VARCHAR2(1000),
  "production_item_id" VARCHAR2(36),
  "production_schedule_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "location" VARCHAR2(100),
...
CREATE TABLE "production_content" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "production_operation_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "created_at" TIMESTAMP,
...
CREATE TABLE "production_assignment" (
  ...
  "description" VARCHAR2(1000),
  "production_operation_id" VARCHAR2(36),
  "equipment_id" VARCHAR2(36),
  "personnel_id" VARCHAR2(36),
  "index_no" NUMBER,
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
...
CREATE TABLE "production_schedule" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "production_order_id" VARCHAR2(36),
  "production_operation_id" VARCHAR2(36),
  "equipment_id" VARCHAR2(36),
  "personnel_id" VARCHAR2(36),
  "production_line_id" VARCHAR2(36),
  "production_item_id" VARCHAR2(36),
  "index_no" NUMBER,
  "specification" VARCHAR2(1000),
  "planned_value" NUMBER,
...
CREATE TABLE "production_result" (
  ...
  "description" VARCHAR2(1000),
  "production_schedule_id" VARCHAR2(36),
  "production_content_id" VARCHAR2(36),
  "personnel_id" VARCHAR2(36),
  "production_item_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
...
CREATE TABLE "production_countermeasure" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "production_issue_id" VARCHAR2(36),
  "index_no" NUMBER,
  "note" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
...
CREATE TABLE "equipment_structure" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "parent_equipment_group_id" VARCHAR2(36),
  "child_equipment_group_id" VARCHAR2(36),
  "parent_equipment_id" VARCHAR2(36),
  "child_equipment_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "created_at" TIMESTAMP,
...
CREATE TABLE "equipment_countermeasure" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "equipment_issue_id" VARCHAR2(36),
  "index_no" NUMBER,
  "note" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
...
CREATE TABLE "equipment_operation" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "equipment_process_id" VARCHAR2(36),
  "equipment_group_id" VARCHAR2(36),
  "personnel_group_id" VARCHAR2(36),
  "index_no" NUMBER,
  "specification" VARCHAR2(1000),
...
CREATE TABLE "equipment_content" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "equipment_operation_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "created_at" TIMESTAMP,
...
CREATE TABLE "equipment_schedule" (
  ...
  "description" VARCHAR2(1000),
  "equipment_operation_id" VARCHAR2(36),
  "equipment_order_id" VARCHAR2(36),
  "equipment_id" VARCHAR2(36),
  "personnel_id" VARCHAR2(36),
  "index_no" NUMBER,
  "specification" VARCHAR2(1000),
...
CREATE TABLE "equipment_result" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "equipment_content_id" VARCHAR2(36),
  "equipment_schedule_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "location" VARCHAR2(100),
...
CREATE TABLE "personnel_countermeasure" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "personnel_issue_id" VARCHAR2(36),
  "index_no" NUMBER,
  "note" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
...
CREATE TABLE "work_result" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "work_schedule_id" VARCHAR2(36),
  "work_content_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "location" VARCHAR2(100),
...
CREATE TABLE "inventory_schedule" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "inventory_transfer_id" VARCHAR2(36),
  "inventory_order_id" VARCHAR2(36),
  "from_inventory_item_id" VARCHAR2(36),
  "to_inventory_item_id" VARCHAR2(36),
  "index_no" NUMBER,
  "specification" VARCHAR2(1000),
  "planned_value" NUMBER,
  "actual_value" NUMBER,
...
CREATE TABLE "inventory_result" (
  ...
  "description" VARCHAR2(1000),
  "inventory_item_id" VARCHAR2(36),
  "inventory_schedule_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "location" VARCHAR2(100),
...
CREATE TABLE "energy_result" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "energy_schedule_id" VARCHAR2(36),
  "equipment_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
...
CREATE TABLE "sales_order" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "sales_document_id" VARCHAR2(36),
  "sales_item_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "location" VARCHAR2(100),
...
CREATE TABLE "sales_invoice" (
  ...
  "description" VARCHAR2(1000),
  "customer_id" VARCHAR2(36),
  "shipping_result_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "unit_price" NUMBER,
...
CREATE TABLE "purchase_order" (
  ...
  "status" VARCHAR2(100),
  "description" VARCHAR2(1000),
  "purchase_document_id" VARCHAR2(36),
  "purchase_item_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "location" VARCHAR2(100),
...
CREATE TABLE "purchase_invoice" (
  ...
  "description" VARCHAR2(1000),
  "supplier_id" VARCHAR2(36),
  "receiving_result_id" VARCHAR2(36),
  "specification" VARCHAR2(1000),
  "value" NUMBER,
  "unit" VARCHAR2(100),
  "unit_price" NUMBER,
...
ALTER TABLE "production_plan" ADD CONSTRAINT "fk_production_plan_production_" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "capacity_plan" ADD CONSTRAINT "fk_capacity_plan_equipment_gro" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "capacity_plan" ADD CONSTRAINT "fk_capacity_plan_personnel_gro" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "sales_plan" ADD CONSTRAINT "fk_sales_plan_production_item_" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "purchase_plan" ADD CONSTRAINT "fk_purchase_plan_production_it" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "asset_structure" ADD CONSTRAINT "fk_asset_structure_parent_asse" FOREIGN KEY ("parent_asset_group_id") REFERENCES "asset_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "asset_structure" ADD CONSTRAINT "fk_asset_structure_child_asset" FOREIGN KEY ("child_asset_group_id") REFERENCES "asset_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "asset_structure" ADD CONSTRAINT "fk_asset_structure_parent_as_1" FOREIGN KEY ("parent_asset_id") REFERENCES "asset" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "asset_structure" ADD CONSTRAINT "fk_asset_structure_child_ass_1" FOREIGN KEY ("child_asset_id") REFERENCES "asset" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "asset_specification" ADD CONSTRAINT "fk_asset_specification_asset_i" FOREIGN KEY ("asset_id") REFERENCES "asset" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "monitoring_result" ADD CONSTRAINT "fk_monitoring_result_monitorin" FOREIGN KEY ("monitoring_content_id") REFERENCES "monitoring_content" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "production_item" ADD CONSTRAINT "fk_production_item_production_" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item" ADD CONSTRAINT "fk_production_item_productio_1" FOREIGN KEY ("production_process_id") REFERENCES "production_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_structure" ADD CONSTRAINT "fk_production_item_structure_p" FOREIGN KEY ("parent_production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_structure" ADD CONSTRAINT "fk_production_item_structure_c" FOREIGN KEY ("child_production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_structure" ADD CONSTRAINT "fk_production_item_structure_1" FOREIGN KEY ("parent_production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_structure" ADD CONSTRAINT "fk_production_item_structure_2" FOREIGN KEY ("child_production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_function" ADD CONSTRAINT "fk_production_item_function_pr" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_specification" ADD CONSTRAINT "fk_production_item_specificati" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_portion" ADD CONSTRAINT "fk_production_item_portion_pro" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_document" ADD CONSTRAINT "fk_production_item_document_pr" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_issue" ADD CONSTRAINT "fk_production_item_issue_produ" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_issue" ADD CONSTRAINT "fk_production_item_issue_pro_1" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_countermeasure" ADD CONSTRAINT "fk_production_item_countermeas" FOREIGN KEY ("production_item_issue_id") REFERENCES "production_item_issue" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_result" ADD CONSTRAINT "fk_production_item_result_prod" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_item_result" ADD CONSTRAINT "fk_production_item_result_pr_1" FOREIGN KEY ("production_schedule_id") REFERENCES "production_schedule" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_process" ADD CONSTRAINT "fk_production_process_producti" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_operation" ADD CONSTRAINT "fk_production_operation_produc" FOREIGN KEY ("production_process_id") REFERENCES "production_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_operation" ADD CONSTRAINT "fk_production_operation_equipm" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_operation" ADD CONSTRAINT "fk_production_operation_person" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_content" ADD CONSTRAINT "fk_production_content_producti" FOREIGN KEY ("production_operation_id") REFERENCES "production_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_assignment" ADD CONSTRAINT "fk_production_assignment_produ" FOREIGN KEY ("production_operation_id") REFERENCES "production_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_assignment" ADD CONSTRAINT "fk_production_assignment_equip" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_assignment" ADD CONSTRAINT "fk_production_assignment_perso" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "production_capacity" ADD CONSTRAINT "fk_production_capacity_product" FOREIGN KEY ("production_item_group_id") REFERENCES "production_item_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_order" ADD CONSTRAINT "fk_production_order_production" FOREIGN KEY ("production_process_id") REFERENCES "production_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_order" ADD CONSTRAINT "fk_production_order_producti_1" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_schedule" ADD CONSTRAINT "fk_production_schedule_product" FOREIGN KEY ("production_order_id") REFERENCES "production_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_schedule" ADD CONSTRAINT "fk_production_schedule_produ_1" FOREIGN KEY ("production_operation_id") REFERENCES "production_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_schedule" ADD CONSTRAINT "fk_production_schedule_equipme" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_schedule" ADD CONSTRAINT "fk_production_schedule_personn" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_schedule" ADD CONSTRAINT "fk_production_schedule_produ_2" FOREIGN KEY ("production_line_id") REFERENCES "production_line" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_schedule" ADD CONSTRAINT "fk_production_schedule_produ_3" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_performance" ADD CONSTRAINT "fk_production_performance_term" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_performance" ADD CONSTRAINT "fk_production_performance_prod" FOREIGN KEY ("production_process_id") REFERENCES "production_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_result" ADD CONSTRAINT "fk_production_result_productio" FOREIGN KEY ("production_schedule_id") REFERENCES "production_schedule" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_result" ADD CONSTRAINT "fk_production_result_product_1" FOREIGN KEY ("production_content_id") REFERENCES "production_content" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_result" ADD CONSTRAINT "fk_production_result_personnel" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_result" ADD CONSTRAINT "fk_production_result_product_2" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_document" ADD CONSTRAINT "fk_production_document_equipme" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_document" ADD CONSTRAINT "fk_production_document_product" FOREIGN KEY ("production_process_id") REFERENCES "production_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_issue" ADD CONSTRAINT "fk_production_issue_production" FOREIGN KEY ("production_process_id") REFERENCES "production_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_issue" ADD CONSTRAINT "fk_production_issue_equipment_" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_issue" ADD CONSTRAINT "fk_production_issue_equipmen_1" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "production_countermeasure" ADD CONSTRAINT "fk_production_countermeasure_p" FOREIGN KEY ("production_issue_id") REFERENCES "production_issue" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment" ADD CONSTRAINT "fk_equipment_production_line_i" FOREIGN KEY ("production_line_id") REFERENCES "production_line" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "equipment" ADD CONSTRAINT "fk_equipment_equipment_group_i" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "equipment_group" ADD CONSTRAINT "fk_equipment_group_asset_group" FOREIGN KEY ("asset_group_id") REFERENCES "asset_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_structure" ADD CONSTRAINT "fk_equipment_structure_parent_" FOREIGN KEY ("parent_equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_structure" ADD CONSTRAINT "fk_equipment_structure_child_e" FOREIGN KEY ("child_equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_structure" ADD CONSTRAINT "fk_equipment_structure_paren_1" FOREIGN KEY ("parent_equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_structure" ADD CONSTRAINT "fk_equipment_structure_child_1" FOREIGN KEY ("child_equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_function" ADD CONSTRAINT "fk_equipment_function_equipmen" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_specification" ADD CONSTRAINT "fk_equipment_specification_equ" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_portion" ADD CONSTRAINT "fk_equipment_portion_equipment" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_document" ADD CONSTRAINT "fk_equipment_document_equipmen" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_issue" ADD CONSTRAINT "fk_equipment_issue_equipment_i" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_issue" ADD CONSTRAINT "fk_equipment_issue_equipment_g" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_countermeasure" ADD CONSTRAINT "fk_equipment_countermeasure_eq" FOREIGN KEY ("equipment_issue_id") REFERENCES "equipment_issue" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_process" ADD CONSTRAINT "fk_equipment_process_equipment" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_operation" ADD CONSTRAINT "fk_equipment_operation_equipme" FOREIGN KEY ("equipment_process_id") REFERENCES "equipment_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_operation" ADD CONSTRAINT "fk_equipment_operation_equip_1" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_operation" ADD CONSTRAINT "fk_equipment_operation_personn" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_content" ADD CONSTRAINT "fk_equipment_content_equipment" FOREIGN KEY ("equipment_operation_id") REFERENCES "equipment_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_assignment" ADD CONSTRAINT "fk_equipment_assignment_equipm" FOREIGN KEY ("equipment_operation_id") REFERENCES "equipment_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_assignment" ADD CONSTRAINT "fk_equipment_assignment_equi_1" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_assignment" ADD CONSTRAINT "fk_equipment_assignment_person" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "equipment_capacity" ADD CONSTRAINT "fk_equipment_capacity_equipmen" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_order" ADD CONSTRAINT "fk_equipment_order_equipment_p" FOREIGN KEY ("equipment_process_id") REFERENCES "equipment_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_schedule" ADD CONSTRAINT "fk_equipment_schedule_equipmen" FOREIGN KEY ("equipment_operation_id") REFERENCES "equipment_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_schedule" ADD CONSTRAINT "fk_equipment_schedule_equipm_1" FOREIGN KEY ("equipment_order_id") REFERENCES "equipment_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_schedule" ADD CONSTRAINT "fk_equipment_schedule_equipm_2" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_schedule" ADD CONSTRAINT "fk_equipment_schedule_personne" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_performance" ADD CONSTRAINT "fk_equipment_performance_term_" FOREIGN KEY ("term_id") REFERENCES "term" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_performance" ADD CONSTRAINT "fk_equipment_performance_equip" FOREIGN KEY ("equipment_process_id") REFERENCES "equipment_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_result" ADD CONSTRAINT "fk_equipment_result_equipment_" FOREIGN KEY ("equipment_content_id") REFERENCES "equipment_content" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "equipment_result" ADD CONSTRAINT "fk_equipment_result_equipmen_1" FOREIGN KEY ("equipment_schedule_id") REFERENCES "equipment_schedule" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel" ADD CONSTRAINT "fk_personnel_production_line_i" FOREIGN KEY ("production_line_id") REFERENCES "production_line" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "personnel" ADD CONSTRAINT "fk_personnel_personnel_group_i" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_group" ADD CONSTRAINT "fk_personnel_group_asset_group" FOREIGN KEY ("asset_group_id") REFERENCES "asset_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_structure" ADD CONSTRAINT "fk_personnel_structure_personn" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_structure" ADD CONSTRAINT "fk_personnel_structure_perso_1" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_skill" ADD CONSTRAINT "fk_personnel_skill_personnel_i" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_specification" ADD CONSTRAINT "fk_personnel_specification_per" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_portion" ADD CONSTRAINT "fk_personnel_portion_personnel" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_document" ADD CONSTRAINT "fk_personnel_document_personne" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_issue" ADD CONSTRAINT "fk_personnel_issue_personnel_i" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_issue" ADD CONSTRAINT "fk_personnel_issue_personnel_g" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "personnel_countermeasure" ADD CONSTRAINT "fk_personnel_countermeasure_pe" FOREIGN KEY ("personnel_issue_id") REFERENCES "personnel_issue" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_process" ADD CONSTRAINT "fk_work_process_personnel_grou" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_operation" ADD CONSTRAINT "fk_work_operation_work_process" FOREIGN KEY ("work_process_id") REFERENCES "work_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_operation" ADD CONSTRAINT "fk_work_operation_equipment_gr" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_operation" ADD CONSTRAINT "fk_work_operation_personnel_gr" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_content" ADD CONSTRAINT "fk_work_content_work_operation" FOREIGN KEY ("work_operation_id") REFERENCES "work_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_assignment" ADD CONSTRAINT "fk_work_assignment_work_operat" FOREIGN KEY ("work_operation_id") REFERENCES "work_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_assignment" ADD CONSTRAINT "fk_work_assignment_personnel_i" FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "work_assignment" ADD CONSTRAINT "fk_work_assignment_equipment_i" FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "work_capacity" ADD CONSTRAINT "fk_work_capacity_personnel_gro" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "work_schedule" ADD CONSTRAINT "fk_work_schedule_work_operatio" FOREIGN KEY ("work_operation_id") REFERENCES "work_operation" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "work_performance" ADD CONSTRAINT "fk_work_performance_work_proce" FOREIGN KEY ("work_process_id") REFERENCES "work_process" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "work_result" ADD CONSTRAINT "fk_work_result_work_schedule_i" FOREIGN KEY ("work_schedule_id") REFERENCES "work_schedule" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "inventory_item" ADD CONSTRAINT "fk_inventory_item_production_i" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_item" ADD CONSTRAINT "fk_inventory_item_production_l" FOREIGN KEY ("production_line_id") REFERENCES "production_line" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "inventory_capacity" ADD CONSTRAINT "fk_inventory_capacity_producti" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_order" ADD CONSTRAINT "fk_inventory_order_production_" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_order" ADD CONSTRAINT "fk_inventory_order_productio_1" FOREIGN KEY ("production_order_id") REFERENCES "production_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_schedule" ADD CONSTRAINT "fk_inventory_schedule_inventor" FOREIGN KEY ("inventory_transfer_id") REFERENCES "inventory_transfer" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_schedule" ADD CONSTRAINT "fk_inventory_schedule_invent_1" FOREIGN KEY ("inventory_order_id") REFERENCES "inventory_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_schedule" ADD CONSTRAINT "fk_inventory_schedule_from_inv" FOREIGN KEY ("from_inventory_item_id") REFERENCES "inventory_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_schedule" ADD CONSTRAINT "fk_inventory_schedule_to_inven" FOREIGN KEY ("to_inventory_item_id") REFERENCES "inventory_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_transfer" ADD CONSTRAINT "fk_inventory_transfer_inventor" FOREIGN KEY ("inventory_item_id") REFERENCES "inventory_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_transfer" ADD CONSTRAINT "fk_inventory_transfer_equipmen" FOREIGN KEY ("equipment_group_id") REFERENCES "equipment_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_transfer" ADD CONSTRAINT "fk_inventory_transfer_personne" FOREIGN KEY ("personnel_group_id") REFERENCES "personnel_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_result" ADD CONSTRAINT "fk_inventory_result_inventory_" FOREIGN KEY ("inventory_item_id") REFERENCES "inventory_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "inventory_result" ADD CONSTRAINT "fk_inventory_result_inventor_1" FOREIGN KEY ("inventory_schedule_id") REFERENCES "inventory_schedule" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "energy_specification" ADD CONSTRAINT "fk_energy_specification_energy" FOREIGN KEY ("energy_id") REFERENCES "energy" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "energy_capacity" ADD CONSTRAINT "fk_energy_capacity_energy_grou" FOREIGN KEY ("energy_group_id") REFERENCES "energy_group" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "energy_schedule" ADD CONSTRAINT "fk_energy_schedule_energy_orde" FOREIGN KEY ("energy_order_id") REFERENCES "energy_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_performance" ADD CONSTRAINT "fk_energy_performance_energy_n" FOREIGN KEY ("energy_node_id") REFERENCES "energy_node" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "energy_result" ADD CONSTRAINT "fk_energy_result_energy_schedu" FOREIGN KEY ("energy_schedule_id") REFERENCES "energy_schedule" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "sales_item" ADD CONSTRAINT "fk_sales_item_production_item_" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "sales_order" ADD CONSTRAINT "fk_sales_order_sales_document_" FOREIGN KEY ("sales_document_id") REFERENCES "sales_document" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "sales_specification" ADD CONSTRAINT "fk_sales_specification_sales_i" FOREIGN KEY ("sales_item_id") REFERENCES "sales_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "sales_invoice" ADD CONSTRAINT "fk_sales_invoice_shipping_resu" FOREIGN KEY ("shipping_result_id") REFERENCES "shipping_result" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "sales_forecast" ADD CONSTRAINT "fk_sales_forecast_sales_item_i" FOREIGN KEY ("sales_item_id") REFERENCES "sales_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "sales_quotation" ADD CONSTRAINT "fk_sales_quotation_sales_item_" FOREIGN KEY ("sales_item_id") REFERENCES "sales_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "shipping_result" ADD CONSTRAINT "fk_shipping_result_sales_order" FOREIGN KEY ("sales_order_id") REFERENCES "sales_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_item" ADD CONSTRAINT "fk_purchase_item_production_it" FOREIGN KEY ("production_item_id") REFERENCES "production_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "purchase_document" ADD CONSTRAINT "fk_purchase_document_supplier_" FOREIGN KEY ("supplier_id") REFERENCES "supplier" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_order" ADD CONSTRAINT "fk_purchase_order_purchase_doc" FOREIGN KEY ("purchase_document_id") REFERENCES "purchase_document" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_order" ADD CONSTRAINT "fk_purchase_order_purchase_ite" FOREIGN KEY ("purchase_item_id") REFERENCES "purchase_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_specification" ADD CONSTRAINT "fk_purchase_specification_purc" FOREIGN KEY ("purchase_item_id") REFERENCES "purchase_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_invoice" ADD CONSTRAINT "fk_purchase_invoice_supplier_i" FOREIGN KEY ("supplier_id") REFERENCES "supplier" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_invoice" ADD CONSTRAINT "fk_purchase_invoice_receiving_" FOREIGN KEY ("receiving_result_id") REFERENCES "receiving_result" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_forecast" ADD CONSTRAINT "fk_purchase_forecast_purchase_" FOREIGN KEY ("purchase_item_id") REFERENCES "purchase_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_quotation" ADD CONSTRAINT "fk_purchase_quotation_supplier" FOREIGN KEY ("supplier_id") REFERENCES "supplier" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "purchase_quotation" ADD CONSTRAINT "fk_purchase_quotation_purchase" FOREIGN KEY ("purchase_item_id") REFERENCES "purchase_item" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "receiving_result" ADD CONSTRAINT "fk_receiving_result_purchase_o" FOREIGN KEY ("purchase_order_id") REFERENCES "purchase_order" ("id") DEFERRABLE INITIALLY IMMEDIATE;
